...
Pod::Spec.new do |s|
  s.name             = 'WechatNoPaySwiftPod'
  s.version          = '1.9.2.2'
  s.summary          = 'wechat without pay pod framework swift support'
  s.swift_version = '5'
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.homepage         = 'https://github.com/DarkAngel7/WechatSwiftPod'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'spec' => 'darkangel@gmail.com' }
  s.source           = { :git => 'https://github.com/DarkAngel7/WechatSwiftPod.git', :tag => s.version.to_s }
